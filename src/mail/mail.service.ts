...
import { MAIL_HOST, MAIL_PASSWORD, MAIL_PORT, MAIL_SENDER, MAIL_USERNAME } from 'src/config/env.config';
...
export class MailService {
    ...
    async sendResetEmail(email: string, resetToken: string) {
        const webhookURL = `http://localhost:5173/reset-password` // change this to your webhook URL, where you want to send the reset link
